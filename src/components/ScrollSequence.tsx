...
export default function ScrollSequence() {
  ...
  return (
    <section ref={containerRef} className="relative bg-[#0B0F19] w-full h-[200vh]">
      <div
        ref={pinWrapperRef}
      ...
      >
        ...
        <div
          ref={overlayRef}
          className="absolute inset-0 bg-[#0B0F19] opacity-30 z-10 pointer-events-none"
        />
        ...
        <div className="absolute inset-0 flex items-center justify-center z-20 max-w-5xl mx-auto px-6">
          <div className="flex flex-col items-center justify-center text-center space-y-10 w-full">
            <div className="flex flex-col justify-center items-center text-center space-y-10">
              <h2
                ref={textRef}
                className="text-white text-[clamp(24px,4.5vw,48px)] font-light tracking-tight leading-relaxed select-none max-w-4xl flex flex-wrap justify-center text-center"
              >
              ...
              <div ref={ctaRef} className="flex gap-6 justify-center opacity-0">
                <Link
                  href="/projects"
                  className="inline-flex items-center gap-3 px-8 py-4 bg-[#11385B] hover:bg-[#4A9DD4] text-white rounded-full text-xs font-semibold uppercase tracking-wider transition-colors cursor-pointer shadow-lg shadow-black/30"
                >
